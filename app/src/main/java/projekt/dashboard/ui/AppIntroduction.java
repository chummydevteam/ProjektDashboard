...
public class AppIntroduction extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance(getString(R.string.third_slide_title), getString(R.string.third_slide_description), R.drawable.creative_mode, Color.parseColor("#212021")));
        addSlide(AppIntroFragment.newInstance(getString(R.string.fourth_slide_title), getString(R.string.fourth_slide_description), R.drawable.phone_heart, Color.parseColor("#212021")));
        addSlide(AppIntroFragment.newInstance(getString(R.string.fifth_slide_title), getString(R.string.fifth_slide_description), R.drawable.theme_utilities, Color.parseColor("#212021")));
        addSlide(AppIntroFragment.newInstance(getString(R.string.sixth_slide_title), getString(R.string.sixth_slide_description), R.drawable.needs_root, Color.parseColor("#212021")));
