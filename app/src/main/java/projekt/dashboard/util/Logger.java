...
import static projekt.dashboard.config.CardConfig.LOG_DETAILED;
import static projekt.dashboard.config.CardConfig.LOG_LEVEL;
import static projekt.dashboard.config.CardConfig.LOG_LEVEL_DEBUG;
import static projekt.dashboard.config.CardConfig.LOG_LEVEL_ERROR;
