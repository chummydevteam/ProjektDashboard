...
import projekt.dashboard.util.HeaderCreatorMode;

/**
 * @author Nicholas Chum (nicholaschum)
 */
public class HeaderCreatorFragment extends BasePageFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mCardStackLayout != null) {
            ...
            mCardStackLayout.setAdapter(new HeaderCreatorMode(getActivity()));
        } else {
